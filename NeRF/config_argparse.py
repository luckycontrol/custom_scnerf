...
def config_parser():
    ...
    parser.add_argument("--expname", type=str, default='ship_4dir_full_pose', help='experiment name')
    parser.add_argument("--basedir", type=str, default='./logs/', help='where to store ckpts and logs')
    parser.add_argument("--datadir", type=str, default='./data/ship_4dir', help='input data directory')
